...
- Active JTIs tracked in Redis sorted set `user_jtis:<userId>` — `revokeAllForUser()` scans this to force-revoke all sessions
...
- Redis unavailable → JTI tracking skipped, revocation is fail-open (graceful degradation)

## Related Nodes

[[Auth Service]] · [[JWT Model]] · [[RBAC System]] · [[Users Table]] · [[Tool Permissions Table]] · [[API Gateway]] · [[Token Manager]]
