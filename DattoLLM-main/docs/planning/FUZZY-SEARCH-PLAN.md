...
tags:
  ...
  - performance
type: Planning
description: Fuzzy search and context overflow fix design — pg_trgm, ILIKE cascade, Stage 2 compression
aliases:
  - Fuzzy Search Plan
---
...
[[AI Service]] (`cachedQueries.ts`) · [[PostgreSQL]] (`db/018_fuzzy_search.sql`) · [[local-data]] (fuzzy search section)

## Related Nodes

[[Chat Request Flow]] · [[MCP Bridge]] · [[MCP Server]] · [[API Gateway]] · [[RBAC System]] · [[Token Manager]] · [[SECURITY_FINDINGS]] · [[SEC-CACHE-001-PLAN]]
