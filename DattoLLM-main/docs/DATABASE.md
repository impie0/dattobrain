...
### `tool_permissions` — [[Tool Permissions Table]]
...
**This is the source of truth for [[RBAC System|RBAC]].** Adding a row grants the tool; removing revokes it. Changes take effect at the user's next token refresh (JWT re-issued).
