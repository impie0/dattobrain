...
> [!info] HNSW Index (SEC-014)
> Replaced IVFFlat with HNSW for better recall and no training phase requirement.

```sql
-- db/014_hnsw_index.sql
...
- [[AI Service]] — writes chat history, reads for context, performs vector search
- [[Embedding Service]] — generates the `vector(1024)` embeddings stored in `embedding` column
- [[Web App]] — displays conversation history and chat UI

## Related Nodes

[[AI Service]] · [[Embedding Service]] · [[Prompt Builder]] · [[Chat Request Flow]] · [[PostgreSQL]] · [[Users Table]] · [[Observability Dashboard]] · [[Web App]]
