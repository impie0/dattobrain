...
echo ""
echo "=== Upstreams ==="
call "auth-service"  PUT "upstreams/1" '{"name":"auth-service","type":"roundrobin","nodes":{"auth-service:3001":1}}'
call "ai-service"    PUT "upstreams/2" '{"name":"ai-service","type":"roundrobin","nodes":{"ai-service:3002":1}}'
